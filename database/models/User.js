...
module.exports = function (sequelize, DataTypes) {
  ...
  User.getUniqueRefId = async function () {
    ...
    let ref_id_exists = await User.search("ref_id", ref_id);

    if (!ref_id_exists) {
      return ref_id;
    } else {
      return User.getUniqueRefId();
    }
  };
  ...
  //     if (role && role.meta) this.permissions = JSON.parse(role.meta);
  //   }
